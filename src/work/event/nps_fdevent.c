...
fdevent* fdevent_init(size_t maxfds, fdevent_handler_t type)
{
	...
	case FDEVENT_HANDLER_POLL:
		...
		NPS_LOG(NPS_LOG_ERR, "event-handler poll failed");
		return NULL;
	    }
	    return ev;
	...
	case FDEVENT_HANDLER_SELECT:
		...
		NPS_LOG(NPS_LOG_ERR, "event-handler select failed");
		return NULL;
	    }
	    return ev;
	...
	case FDEVENT_HANDLER_LINUX_SYSEPOLL:
		...
		NPS_LOG(NPS_LOG, "event-handler linux-epoll failed");
		return NULL;
	    }
	    return ev;
    ...
    NPS_LOG(NPS_LOG_ERR, "event-handler is unknown");
    return NULL;
}
